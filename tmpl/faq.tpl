...
<h3>FAQ.</h3><br>
<p align=justify> <b>How can I invest with {$settings.site_name} ?</b><br>
  To make a investment you must first become a member of {$settings.site_name} hyip. Once 
  ...
  <br>
  <b>I wish to invest with {$settings.site_name} but I don't have an any ecurrency account. What 
  should I do?</b><br>
  You can open a free Payeer account here: <a href="http://www.payeer.com/">www.payeer.com</a><br>
  You can open a free PM account here: <a href="http://www.perfectmoney.com/">www.perfectmoney.com</a><br>
You can open a free STP account here: <a href="http://www.solidtrustpay.com/">www.solidtrustpay.com</a><br>
You can open a free Bitcoin account here: <a href="http://www.bitcoin.com/">www.bitcoin.com</a><br>
  <br>
  <br>
  <b>How do I open my {$settings.site_name} HYIP Account?</b><br>
  ...
  Log into your {$settings.site_name} account and click on the "Account Information". You 
  ...
  No, profits are gathered on your {$settings.site_name} account and you can withdraw them 
  anytime. <br>
  <br>
  <b>How do you calculate the interest on my account?</b><br>
  Depending on each plan. Interest on your {$settings.site_name} HYIP account is acquired 
  ...
  Yes! To make a deposit from your {$settings.site_name} HYIP account balance. Simply login 
  into your members account and click on Make Deposit ans select the Deposit from 
  Account Balance Radio button. <br>
  <br>
  <b>Can I make an additional deposit to {$settings.site_name} HYIP account once it has 
  been opened?</b><br>
  ...
  To make a spend you must first become a member of {$settings.site_name} HYIP. Once you 
  ...
  These funds are managed by a team of {$settings.site_name} HYIP investment experts. <br>
  <br>
